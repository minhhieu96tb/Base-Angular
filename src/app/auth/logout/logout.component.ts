...
import { LogoutActions, ApplicationPaths, ReturnUrlType, ClientConfig } from '../api-authorization.constants';
...
export class LogoutComponent implements OnInit {
  ...
  private async removeRoleUser(){
    sessionStorage.removeItem('permision_user');
  }
}
